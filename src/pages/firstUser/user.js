      ...
      <View style={{flex:1,}}>
        ...
        <View style={{marginBottom:30,}}>
          <View>
            ...
            <Text style={{fontSize:24,marginTop:0,color:'#396eee',fontWeight:'bold',letterSpacing:-0.7}}>데일리세탁</Text>
          </View>
        ...
        <Animated.View style={{width:lineScale,height:2,backgroundColor:'#396eee'}}/>
          ...
          renderItem={({item}) =>
            ...
            >
              <View style={{flexDirection:'row',alignItems:'center',borderBottomWidth:1,borderColor:'#e2e2e2',paddingVertical:15}}>
                <Icon name="map-marker" size={28} style={{width:40,}} color={'#396eee'}/>
                <View>
